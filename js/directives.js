...
angular.module('vaterDotcom.directives', []).
  ...
  .directive('toggleSubnav', function(){
    return {
      ...
      link:function(scope, elem, attrs){
        elem.bind('click', function(e){
            $(e.target).children('i').toggleClass('fa-rotate-90');
  ...
  .directive('toggleSearch', function($rootScope){
     return {
      restrict:'A',
      link:function(scope, elem, attrs){
        elem.bind('click', function(e){
  ...
  .directive('randomBg', function($rootScope){
    return{
      restrict:'A',
      link:function(scope, elem, attrs){
        var imgList = ['blue1', 'blue2', 'blue3', 'blue4', 'blue5', 'blue6'];
    ...
    return{
      ...
      link: function(scope, elem, attrs){
       ...
       $(elem).on('mousemove', function(event){
        ...
        console.log($(elem).siblings('#zoom').find('img').width());
